  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Collapsible title="Human Interaction" description="Interaction mode and escalation policies">
          <HumanInteractionSection />
        </Collapsible>

        <Collapsible title="Agent Collaboration" description="Multi-agent relationships and coordination">
          <AgentCollaborationSection />
        </Collapsible>

        <Collapsible title="Memory & State" description="Shared memory across skills">
          <MemorySection />
        </Collapsible>
      </div>
    </div>
